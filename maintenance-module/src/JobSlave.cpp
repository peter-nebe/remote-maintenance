...
template<>
JobSlave<FileTransferJobs>::JobSlave(const string &deviceId)
: topic(network::prefix + network::fileTransfer + deviceId),
  resultsTopic(network::prefix + network::jobResults + deviceId),
  networkClient(deviceId)
{
}
